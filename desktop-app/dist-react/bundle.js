(() => {
  ...
  function Select({
    ...
    return /* @__PURE__ */ import_react.default.createElement("div", { ref: selectRef, className: cn("relative inline-block", className) }, /* @__PURE__ */ import_react.default.createElement(
      "button",
      {
      ...
      /* @__PURE__ */ import_react.default.createElement("span", { className: "truncate" }, selectedOption?.label),
      /* @__PURE__ */ import_react.default.createElement(
        ...
        /* @__PURE__ */ import_react.default.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M19 9l-7 7-7-7" })
      )
    ), isOpen && /* @__PURE__ */ import_react.default.createElement("div", { className: "absolute top-full left-0 z-50 mt-1 w-full min-w-[8rem] overflow-hidden rounded-md border border-border bg-card text-foreground shadow-md animate-in fade-in-0 zoom-in-95" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "p-1" }, options.map((opt) => /* @__PURE__ */ import_react.default.createElement(
      "button",
      {
        key: opt.value,
        onClick: () => {
      ...
      /* @__PURE__ */ import_react.default.createElement("span", { className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center" }, opt.value === value && /* @__PURE__ */ import_react.default.createElement("svg", { className: "h-4 w-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" }, /* @__PURE__ */ import_react.default.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M5 13l4 4L19 7" }))),
      opt.label
    )))));
  }
  function ReelsMaxing() {
    const [llmProvider, setLlmProvider] = (0, import_react.useState)("chatgpt");
    const [socialPlatform, setSocialPlatform] = (0, import_react.useState)("instagram");
    const [status, setStatus] = (0, import_react.useState)("paused");
    const [isPaused, setIsPaused] = (0, import_react.useState)(true);
    const [reelsWidth, setReelsWidth] = (0, import_react.useState)(400);
    const llmViewRef = (0, import_react.useRef)(null);
    const reelsViewRef = (0, import_react.useRef)(null);
    const wasGeneratingRef = (0, import_react.useRef)(false);
    ...
    return /* @__PURE__ */ import_react.default.createElement("div", { className: "flex h-screen flex-col bg-background" }, /* @__PURE__ */ import_react.default.createElement("header", { className: "flex items-center justify-between border-b border-border bg-card px-5 py-3", style: { WebkitAppRegion: "drag" } }, /* @__PURE__ */ import_react.default.createElement("div", { className: "flex items-center gap-3" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "flex h-9 w-9 items-center justify-center rounded-lg bg-primary/10 overflow-hidden" }, /* @__PURE__ */ import_react.default.createElement("img", { src: "ReelsMax_logo.jpg", alt: "ReelsMaxing", className: "h-9 w-9 object-contain" })), /* @__PURE__ */ import_react.default.createElement("h1", { className: "text-lg font-semibold text-foreground" }, "ReelsMaxing")), /* @__PURE__ */ import_react.default.createElement("div", { className: "flex items-center gap-2", style: { WebkitAppRegion: "no-drag" } }, /* @__PURE__ */ import_react.default.createElement(
      "div",
      {
        className: cn(
    ...
    ), /* @__PURE__ */ import_react.default.createElement("span", { className: "text-sm text-muted-foreground" }, status === "ready" && "Ready", status === "generating" && "Generating...", status === "paused" && "Paused"))), /* @__PURE__ */ import_react.default.createElement("div", { className: "flex flex-1 overflow-hidden" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "flex flex-1 flex-col border-r border-border" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "flex h-10 items-center gap-2 border-b border-border bg-muted/30 px-4" }, /* @__PURE__ */ import_react.default.createElement(
      "svg",
      {
    ...
    ), /* @__PURE__ */ import_react.default.createElement("div", { className: "flex flex-col shrink-0", style: { width: `${reelsWidth}px` } }, /* @__PURE__ */ import_react.default.createElement("div", { className: "relative flex h-10 items-center gap-2 border-b border-border bg-muted/30 px-4 z-30" }, /* @__PURE__ */ import_react.default.createElement(
      "svg",
      {
        className: "h-4 w-4 text-muted-foreground",
        fill: "none",
    ...
    )), /* @__PURE__ */ import_react.default.createElement("div", { className: "relative flex-1" }, /* @__PURE__ */ import_react.default.createElement(
      "webview",
      {
        ref: reelsViewRef,
    ...
    ), isPaused && /* @__PURE__ */ import_react.default.createElement("div", { className: "absolute inset-0 flex flex-col items-center justify-center bg-background/90 backdrop-blur-sm z-20" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-primary/10" }, /* @__PURE__ */ import_react.default.createElement(
      "svg",
      {
    ...
    )), /* @__PURE__ */ import_react.default.createElement("h2", { className: "mb-2 text-xl font-semibold text-foreground" }, "AI Response Ready!"), /* @__PURE__ */ import_react.default.createElement("p", { className: "mb-1 text-sm text-muted-foreground" }, "Read the response in the chat"), /* @__PURE__ */ import_react.default.createElement("p", { className: "text-xs text-muted-foreground/60" }, "Generate a new prompt to continue watching"))))));
  }
  var container = document.getElementById("root");
  if (container) {
    const root = (0, import_client.createRoot)(container);
    root.render(/* @__PURE__ */ import_react.default.createElement(ReelsMaxing, null));
  }
})();
